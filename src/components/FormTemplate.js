...
export default props => {
    ...
    const {init, fields, submitButtonText, submitTooltipTitle, submitButtonLabel, submitButtonColor, submitButtonVariant, handleSubmit, handleGet, handleUpdate, handleCopy, handleDelete, handleCancel, update} = props
    const language='EN'
